...
def update():
    ...
    os.system(f"curl https://raw.githubusercontent.com/CosmodiumCS/SkeletonKey/main/version.txt| tee {b.local_path}/latest.txt")
    ...
    if latest_version > current_version:
        ...
        # update
        if option == "y":
            os.system("sh ~/.0xPo11/resources/update.sh")
    ...
    if args_exist:
        ...
        while True:
            ...
            if user_input == 'help':
                ...
                os.system(f'python3 {_main_path}/main.py {user_input.replace("key", "")}')
